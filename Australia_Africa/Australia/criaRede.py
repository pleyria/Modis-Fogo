...
''' Neste codigo, sao criadas redes para cada mes 
    ...
    0.5 long (redes para serem comparadas com a Africa)
'''
...
rd = rd + '/Resultados e Dados/Australia_Africa/Australia'

''' leitura dos arquivos '''

# fire_archive_M6_135341.csv contem dados de 2003-01-01 ate 2019-12-01
df = pd.read_csv(rd + r'/csv/fire_archive_M6_135341.csv')
