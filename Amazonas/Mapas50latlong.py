...
# divisoes do grid
a = 40 # numero de divisoes na latitude
...
for arquivo in f:
    ...
    # salva imagem
    plt.savefig(rd + '/LatLong05/mapas/degree/' + ano + '/' + 
    ...
    # salva imagem
    plt.savefig(rd + '/LatLong05/mapas/betweenness/' + ano + '/' + 
                'mapa' + str(numMapa % 12 + 1) + '_' + mes, bbox_inches='tight')
    plt.close()
    ...
    # salva imagem
    plt.savefig(rd + '/LatLong05/mapas/closeness/' + ano + '/' + 
                'mapa' + str(numMapa % 12 + 1) + '_' + mes, bbox_inches='tight')
    plt.close()
    del dados_closeness
